#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Abu Huraira
...
\033[1;93m▇▇▇▇▇ Facebook\033[1;93m Huraira ▇▇▇▇▇
\033[1;97m
                 ⊂ヽ
               　 ＼＼  Λ＿Λ
              　　 ＼(  ˘ω˘  )
                　　　 >　⌒ヽ
                 ...
                 　 /　/|
                  ...
                  　| |　　) /
                   ノ )    Lﾉ
                  (_／     　　　
\033[1;97m:•◄►•═ ═ ═ ═ ═ ═ ═ •◄►•\033[1;93mHanguTiger\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═ •◄►•"""
...
\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•\033[1;92mHanguTiger\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•"""
print  "\033[1;90m🔀 ⚌⚌⚌⚌⚌⚌⚍⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌ 🔀"
jalan("\033[0;31m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
jalan("\033[0;31m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
jalan("\033[0;31m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
...
jalan("\033[0;31m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷 ") 
jalan("\033[0;31m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
jalan("\033[1;35m☠ Welcome to Huraira King ☠ ") 
jalan("\033[0;33m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
jalan("\033[0;33m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷 ") 
jalan("\033[0;33m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
jalan("\033[0;33m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
jalan("\033[0;33m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
jalan("\033[0;33m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
print "\033[1;93m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•\033[1;92mHanguTiger\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•"

CorrectUsername = "Huraira"
CorrectPassword = "Bangaxh"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Huraira
	    time.sleep(2)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		print "\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═ •◄►•\033[1;92mHanguTiger\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•"
...
def menu():
	...
	print "\033[1;91m-•◄►•-\033[1;97m> \033[1;97m1.\x1b[1;93m Start Cloning India"
        ...
        print "\033[1;91m-•◄►•-\033[1;97m> \033[1;97m9.\x1b[1;91m Hangu Tiger   Massage "
...
def pilih():
	...
	if unikers =="":
		...
		print " \033[1;91m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•Massage•◄►•═ ═ ═ ═ ═ ═ ═•◄►•\n"
                ...
                jalan("\033[1;96mgit clone https://github.com/HurairaBangaxh/Hangu")
                jalan('\033[1;96mcd pakistan407')
                jalan('\033[1;96mpython2 Aahil')
                jalan('\033[1;96mUser: Huraira')
                jalan('\033[1;96mpass: Bangaxh')
                jalan('\033[1;92m👆Copy Command & send 2 groups👆')
                jalan('\033[1;91mI Love Afshu I like Afshu Miss You So Much')
...
def crack():
	...
	print "\033[1;93m-•◄►•-\033[1;97m> \033[1;91m1.\x1b[1;95mClone Friend List Public ID."
        print "\033[1;93m-•◄►•-\033[1;97m> \033[1;91m2.\x1b[1;95mHangu Tiger Facebook Group Pakistan."
        print "\033[1;93m-•◄►•-\033[1;97m> \033[1;91m3.\x1b[1;95mHangu Tiger Group Cloning."
        print "\033[1;93m-•◄►•-\033[1;97m> \033[1;91m4.\x1b[1;95mShah Faisal Youtube Chenal."
...
def pilih_crack():
	...
	if peak =="":
		...
		print "\033[1;95m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•\033[1;91mHanguTiger\033[1;95m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•"
		try:
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•\033[1;91mHurairaTiger\033[1;95m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•"
	print "  \033[1;91m«---•◄►•---Developed By Huraira-Bangaxh--•◄►•---»" #Dev:Huraira
...
•\033[1;95m◄►•═ ═ ═ ═ ═ ═ ═•◄►•═ ═ ═ ═ ═ ═ ═•◄►•.
: \033[1;91m ....Huraira Bangaxh  BlackTiger....... \033[1;95m :
•\033[1;95m◄►•═ ═ ═ ═ ═ ═ ═•◄►•═ ═ ═ ═ ═ ═ ═•◄►•.' 
                JOIN ME
              \033[1;91m FACEBOOK HURAIRA"""
...
def brute():
    ...
    try:
        ...
        try:
            ...
            passw = raw_input('\x1b[1;92m[●] \x1b[1;92mWordlist \x1b[1;97m(Type👉Huraira.txt) \x1b[1;91m: \x1b[1;97m')
            total = open(passw, 'r')
